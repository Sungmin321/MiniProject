...
public class SignUp {
	...
	private String ID, PASSWORD, NAME, BIRTHDAY, EMAIL;
	int SEX_TYPE, PHONE_NUMBER;
		...
		signupButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// 비밀번호, 비밀번호 재확인이 통과되야 다음단계로 넘어감.
					...
					boolean b = new InsertUpdate().isCustomerSignUp(ID, PASSWORD, NAME, SEX_TYPE, BIRTHDAY, EMAIL, PHONE_NUMBER);
