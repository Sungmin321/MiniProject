...
public class PtCountDialogOption extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private String name;

	public PtCountDialogOption(String name) {
		this.name = name;
		...
		{
			JLabel CountLabel = new JLabel(new MemberDAO().getCustomerPtNumber_Name(name));
			...
			dialog.getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (new InsertUpdate().isCustomerPtNumberModify(num, name)) {
