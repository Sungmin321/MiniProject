...
public class Master_PtOption {
	...
	public Master_PtOption() {
		...
		ArrayList<CustomerVo> list = new MemberDAO().Customer_list();
		int size = list.size();
		...
		textField.setText("È¸¿ø ÀÌ¸§À» Àû¾îÁÖ¼¼¿ä");
		textField.setBounds(12, 415, 159, 25);
		canceluppanel.add(textField);
		textField.setColumns(10);

		JButton OptionButton = new JButton("º¯°æ");
